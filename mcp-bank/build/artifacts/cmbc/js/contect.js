...
$(document).ready(function (e) {
    ...
    $(".step2").die().live("click", function () {
        ...
        if (Id == null || Id == "null") {//尚未登陆，需要处理登陆。
...
//        window.alert("user2Id:"+userId+"sign:"+sign);
...
//                    setWebitEvent(result.envelopeData, "LT03");
                ...
                alert("彩币余额不足，多期投注请先充值彩币。");
            } else {
                alert("投注失败，错误码:" + result.description + ",请稍后再投。");
            }
            after();
        }
    });
