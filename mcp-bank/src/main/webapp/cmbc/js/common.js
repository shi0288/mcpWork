...
//		$(".content").css({"max-height":hh+"px"});
//		$(".top").css("position","absolute");
//		$(".footer-tz").css("position","absolute");
//		$(".jc-footer").css("position","absolute");
//		$(".jc-footer2").css("position","absolute");
//		$("html").css({"height":"100%","overflow-y":"hidden"});
//		$("body").css({"height":"100%","overflow-y":"hidden"});
//		$(".tz-more").css("position","absolute");
//	}
