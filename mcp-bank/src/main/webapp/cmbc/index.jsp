...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="css/chest-game.css">
...
<div class="page-from-left index">
    <div class="top fix">
        <div class="top-relative clearfix">
            ...
            <!--<a class="msyh-login" id="yes-user" href="acount.jsp" style="display:none;padding:0px 16px;">我的彩票</a>-->
            <span class="title"
                  style="float:none; display:block; width:220px; text-align:center; margin:0px auto;">中期彩</span>
        </div>
    </div>
    <div class="cb"></div>
    ...
    <center>
        <div class="notice" style="margin-top:20px;margin-bottom:-10px">

            <ul id="jsfoot01" class="noticTipTxt">

            </ul>

            <ul id="copyul" style="height:0px;">

                <li class="li"><span class="xbspan"></span></li>
    ...
    <div class="content start-ms clearfix" style="margin-top:0px" id="more">
        ...
        <ul id="caizhong-ul" class="clearfix">
            ...
            <li id="ssq"><a class="ico-box" href="ssq.jsp"><img src="img/ico_ssq.png"/>双色球</a></li>
            <li id="dlt"><a class="ico-box" href="dlt.jsp"><img src="img/ico_dlt.png"/>大乐透</a></li>
            <li id="fc3d"><a class="ico-box" href="fc3d.jsp"><img src="img/ico_3d.png"/>福彩3D</a></li>
            ...
            <li id="qlc"><a class="ico-box" href="qlc.jsp"><img src="img/ico_qlc.png"/>七乐彩</a></li>
            ...
            <!-- <li><a class="ico-box" href="javascript:void(-1)" onClick="addCz(this)"><img src="img/ico_add.png" />添加</a></li>-->
        </ul>
        <ul id="more-ul" class="clearfix">
            ...
            <li><a id="may-caipiao" class="ico-box" href="javascript:void(-1)"><img src="img/icoy_12.png"/>我的彩票</a></li>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $.ajax({
            url: '/openchest/main/winUser.htm?random='+Math.random(),
            type: 'GET',
            ...
            success: function(result){
                if(result.length <=3){
                    $("#jsfoot01").html("<li style='font-size:14px;'>挖宝活动已开启，快来抢彩币！</li>");
                    return false;
                }
                var str = "";
                var parentul = $("#jsfoot01");
                for(var i = 0;i<result.length;i++){
                    var createli = $("#copyul li").clone(true);
                    var phone = result[i].nickname;
                    if(phone){
                        //每次清空copy的值。

                        qphone = phone.substring(0,3);
                        wphone = phone.substring(phone.length-4);
                        var userPrize = result[i].money;
                        //之追加内容
                        createli.html("恭喜"+qphone+"****"+wphone+"挖得彩金"+userPrize+"元");
                        //之追加内容
                        createli.appendTo(parentul);
                    }
                }
                //全部组装完成再赋值
